...
// Immersive auth shell shared by /login and /register. The form card sits
// centered on a full-page animated mesh; the admin-selected course is echoed
// in a compact strip above the form (no side poster).
