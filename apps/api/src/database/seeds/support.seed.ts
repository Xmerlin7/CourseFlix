...
const TICKET_BLUEPRINTS: TicketBlueprint[] = [
  ...
  },
  {
    ...
    studentReply: 'تم، الإيميل الجديد هو نفس الإيميل المسجل به هنا فعلاً، تم الحل شكراً.',
  },
  {
    category: 'other',
    subject: 'اقتراح: إضافة وضع ليلي للتطبيق',
    description: 'هل ممكن تضيفوا وضع ليلي (Dark Mode) للموقع؟ بيكون مريح للعين وقت المذاكرة بالليل.',
    status: 'open',
    staffReply: null,
    studentReply: null,
  },
